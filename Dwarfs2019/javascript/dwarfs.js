...
class Dwarf {
    constructor() {
        ...
        this.prevPos = 0;
        this.gold = 0;
        this.purpose = 0 /* DwarfsPurpose.NONE */;
        this.turnBack = false;
        this.height = 70 /* Inline.groundLevel */;
    ...
    buf(palette) {
        return cacheDwarfs[palette[0]] ||
            (cacheDwarfs[palette[0]] = renderBuf(3 /* Inline.B_SCALE */ * 8, 3 /* Inline.B_SCALE */ * 11, this._render.bind(this, palette)));
    }
    advance() {
        ...
        switch (this.purpose) {
            case 1 /* DwarfsPurpose.TREASURE */:
                this.turnBack = false;
                this.pos += speed;
                if (this.pos >= 2 * SCREEN_WIDTH) {
                    this.pos = 2 * SCREEN_WIDTH;
                    this.gold = dwarfCapacity;
                    this.purpose = 2 /* DwarfsPurpose.FORTRESS */;
                }
                break;
            case 2 /* DwarfsPurpose.FORTRESS */:
                this.turnBack = true;
                this.pos -= speed;
                if (this.pos <= 0) {
                    this.pos = 0;
    ...
    haveFun(setPos) {
        ...
        this.gold = 0;
        this.purpose = 3 /* DwarfsPurpose.ALE */;
