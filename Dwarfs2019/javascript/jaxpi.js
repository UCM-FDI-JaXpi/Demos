...
function generateStatement(player, verb, object, sessionKey, result, context, authority) {
    const statement = {
        actor: {
...
function generateObject(objectJson, name, description) {
    const object = {
        ...
        definition: {
            ...
            name: Object.assign({}, objectJson.definition.name), // Clono el campo de objectJason para evitar que me sobreescriba con una referencia
            description: Object.assign({}, objectJson.definition.description),
            extensions: {}
        }
    };
    if (name)
...
class Jaxpi {
        ...
        if (typeof window !== undefined) {
            ...
            function handleSIGINT() {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    self.flush();
                    yield Promise.all(self.promises)
                        .then(() => {
    ...
    statementIdCalc() {
        while (localStorage.getItem(`stat${this.record_id}`) !== null)
            this.record_id++;
    ...
    validateKey(sessionKey) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield fetch(`http://localhost:3000/publicAPI/key/${sessionKey}`);
                if (response.ok) {
    ...
    customVerb(verb, object, parameters, result, context, authority) {
        if (checkObject(object) || typeof object === "string") {
            if (checkVerb(verb) || typeof verb === "string") {
                ...
                if (this.records_queue.length >= this.max_queue_length)
                    this.flush();
            }
            else
