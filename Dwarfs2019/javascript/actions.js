...
$click('btn-portal', () => {
    ...
    updateGold(-60);
    renderPortal(bufFortress.getContext('2d'), 432 - 3 /* Inline.B_SCALE */ * 6, 70 /* Inline.groundLevel */ - 3 /* Inline.B_SCALE */, PAL_PORTAL_BLUE);
    renderPortal(bufFortressExit.getContext('2d'), 432 - 3 /* Inline.B_SCALE */ * 6, 70 /* Inline.groundLevel */ - 3 /* Inline.B_SCALE */, PAL_PORTAL_BLUE);
    renderPortal(bufTreasure.getContext('2d'), 32, 70 /* Inline.groundLevel */ - 3 /* Inline.B_SCALE */, PAL_PORTAL_ORANGE);
    dwarfPortal = true;
    $despawn('portal');
});
$click('btn-delorean', () => {
